...
import CompanyDetailsView from '../../company/view/page';
...
const OrganisationDetailsView: React.FC = () => {
    // Mock data
    ...
    const [organisationData, setOrganisationData] = useState<Organisation | null>(null);
    ...
    useEffect(() => {
        setNavbarData("Organisation Management", "Organisation Management/ View");
        fetchOrganisationGetById(id ?? "")
    ...
    const fetchOrganisationGetById = async (id: string) => {
        if (!token) return;
        try {
            const data = await apiService.getOrganisationById(token, id);
            ...
            <div className="@container/main flex flex-1 flex-col gap-2">
                <div className="flex flex-col gap-4 py-4 md:gap-3 md:py-5">
                    <div className="px-1 lg:px-3">
                        <CompanyCard bus={organisationData} />
                    </div>
                                ...
                                <Card>
                                    <CardHeader>
                                        <CardTitle className="flex items-center gap-2">
                                            ...
                                            <span className='text-[20px] font-semibold'>Organisation Information</span>


                                        </CardTitle>
                                        <CardDescription>Organisation specifications and details</CardDescription>
                                    </CardHeader>
                                    <CardContent>
                                        <div className="space-y-2">
                                            ...
                                            >
                                                ...
                                                <span className="text-[15px] font-semibold text-gray-900">
                                                    {organisationData?.registration_number}
                                                </span>
                                            </div>
                                            <div
...
export default OrganisationDetailsView;