...
import { Organisation, OrganisationTableProps } from "@/types/organisations";
...
const renderCell = (row: Organisation, columnKey: string, onEdit: any, onDelete: any, onView:any) => {
    switch (columnKey) {
...
export default function organisationTable({ organisations, onAdd, onEdit, onDelete,onView }: OrganisationTableProps) {
