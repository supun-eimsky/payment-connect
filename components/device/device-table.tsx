...
import { DeviceFilters, DeviceTableProps, DeviceProps, Devices } from '@/types/device';
...
const COLUMNS = [
    ...
    { key: "device_code", label: "Device Code", defaultVisible: true },
    ...
    { key: "mac_address", label: "mac_address", defaultVisible: true },
    { key: "purchase_date", label: "purchase_date", defaultVisible: true },
    { key: "action", label: "Action", defaultVisible: true }


]
const renderCell = (row: Devices, columnKey: string, onEdit: any, onDelete: any, onView: any) => {
    switch (columnKey) {
        // case "company_id":
        ...
        <>
            ...
            <CardHeader>
                <div className="flex justify-between items-center">
                    <CardTitle className="text-lg">Devices List</CardTitle>
                    <CardAction>
