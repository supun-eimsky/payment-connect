...
import { RoutePermitFilters, RoutePermitProps, RoutePermitTableProps, RoutePermit } from '@/types/route-permits';
...
const COLUMNS = [
    ...
    { key: "permit_number", label: "Permit Number", defaultVisible: true },
    { key: "issued_date", label: "issued_date", defaultVisible: true },
    { key: "status", label: "Status", defaultVisible: true },

    { key: "expiry_date", label: "expiry_date", defaultVisible: true },
    { key: "action", label: "Action", defaultVisible: true }


]
const renderCell = (row: RoutePermit, columnKey: string, onEdit: any, onDelete: any, onView: any) => {
    switch (columnKey) {
        case "route_id":
            return row.route_id
        case "permit_number":
            return row.permit_number
        case "issued_date":
...
export default function RoutePermitTable({ buses, onAdd, onEdit, onDelete, onView }: RoutePermitTableProps) {
        ...
        <>
                ...
                <CardHeader>
                    <div className="flex justify-between items-center">
                        <CardTitle className="text-lg">Route Permits List</CardTitle>
                        <CardAction>
